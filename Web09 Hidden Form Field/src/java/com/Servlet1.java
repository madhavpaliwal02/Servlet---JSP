    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if((sname==null || semail==null || spass==null) || (sname=="" || semail=="" || spass=="")){
                ...
                out.println("<h3><input type='hidden' name='xname' value='"+sname+"'/></h3>");
                out.println("<h3><input type='hidden' name='xemail' value='"+semail+"'/></h3>");
                out.println("<h3><input type='hidden' name='xpass' value='"+spass+"'/></h3>");
